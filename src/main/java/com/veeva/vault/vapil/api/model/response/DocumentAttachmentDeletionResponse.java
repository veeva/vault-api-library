 ...
 */
public class DocumentAttachmentDeletionResponse extends VaultResponse {

	@JsonProperty("data")
	public List<DeleteDocumentAttachment> getData() {
		return (List<DeleteDocumentAttachment>) this.get("data");
	}

	@JsonProperty("data")
	public void setData(List<DeleteDocumentAttachment> data) {
		this.set("data", data);
	}
	...
	public static class DeleteDocumentAttachment extends VaultModel {
