 ...
 */
public class MultiDocumentWorkflowDetailsResponse extends VaultResponse {

	@JsonProperty("data")
	public MultiDocumentWorkflow getData() {
		return (MultiDocumentWorkflow) this.get("data");
	}

	public void setData(MultiDocumentWorkflow data) {
		this.set("data", data);
	}

	public static class MultiDocumentWorkflow extends VaultModel {
