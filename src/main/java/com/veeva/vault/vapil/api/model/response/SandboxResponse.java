...
public class SandboxResponse extends VaultResponse {
    ...
    @JsonProperty("data")
    public SourceVault getData() {
        return (SourceVault) this.get("data");
    }

    public void setData(SourceVault data) {
        this.set("data", data);
    }

    public static class SourceVault extends VaultModel {
        ...
        @JsonProperty("active")
        public List<Sandbox> getActive() {
            return (List<Sandbox>) this.get("active");
        }

        public void setActive(List<Sandbox> active) {
