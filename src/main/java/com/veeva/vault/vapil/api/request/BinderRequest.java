 ...
 * Binder Requests
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/21.2/#binders">https://developer.veevavault.com/api/21.2/#binders</a>
 * <p>
 * <i>Covered in other classes for ease of use:</i><br>
 * <a href="https://developer.veevavault.com/api/21.2/#binder-templates">https://developer.veevavault.com/api/21.2/#binder-templates</a>
 */
public class BinderRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-all-binder-versions' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-all-binder-versions</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder-version' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder-version</a>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#create-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#create-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * POST /api/{version}/objects/binders</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#create-binder-from-template' target='_blank'>https://developer.veevavault.com/api/21.2/#create-binder-from-template</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#create-binder-version' target='_blank'>https://developer.veevavault.com/api/21.2/#create-binder-version</a>
	 * @vapil.request <pre>
	 * resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binder</a>
	 * @vapil.request <pre>
	 * resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#refresh-binder-auto-filing' target='_blank'>https://developer.veevavault.com/api/21.2/#refresh-binder-auto-filing</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binder-version' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binder-version</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#delete-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#delete-binder</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#delete-binder-version' target='_blank'>https://developer.veevavault.com/api/21.2/#delete-binder-version</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder-sections' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder-sections</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder-version-section' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder-version-section</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#create-binder-section' target='_blank'>https://developer.veevavault.com/api/21.2/#create-binder-section</a>
	 * @vapil.request <pre>
	 * <i>Example 1</i>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binder-section' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binder-section</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#delete-binder-section' target='_blank'>https://developer.veevavault.com/api/21.2/#delete-binder-section</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#add-document-to-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#add-document-to-bindern</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#move-document-to-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#move-document-to-bindern</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#remove-document-from-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#remove-document-from-bindern</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder-relationship' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#create-binder-relationship' target='_blank'>https://developer.veevavault.com/api/21.2/#create-binder-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#delete-binder-relationship' target='_blank'>https://developer.veevavault.com/api/21.2/#delete-binder-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#export-binder' target='_blank'>https://developer.veevavault.com/api/21.2/#export-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @return JobCreateResponse
	 * @vapil.api <pre>POST /api/{version}/objects/binders/{binder_id}/actions/export</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#export-binder-sections' target='_blank'>https://developer.veevavault.com/api/21.2/#export-binder-sections</a>
	 * @vapil.request <pre>
	 * JobCreateResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#retrieve-binder-export-results' target='_blank'>https://developer.veevavault.com/api/21.2/#retrieve-binder-export-results</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binding-rule' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binding-rules</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binder-section-binding-rule' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binder-section-binding-rule</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.2/#update-binder-document-binding-rule' target='_blank'>https://developer.veevavault.com/api/21.2/#update-binder-document-binding-rule</a>
	 */
