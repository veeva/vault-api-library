 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions">https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions</a>
 */
public class BulkActiveWorkflowActionRequest extends VaultRequest<BulkActiveWorkflowActionRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/initiate-workflow-actions-on-multiple-workflows' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/initiate-workflow-actions-on-multiple-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/retrieve-bulk-workflow-action-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/retrieve-bulk-workflow-action-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/retrieve-bulk-workflow-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/bulk-active-workflow-actions/retrieve-bulk-workflow-actions</a>
	 * @vapil.request <pre>
