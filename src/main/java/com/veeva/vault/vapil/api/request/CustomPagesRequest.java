 ...
 * </ul>
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages">https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages</a>
 */
...
public class CustomPagesRequest extends VaultRequest<CustomPagesRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/retrieve-all-client-code-distribution-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/retrieve-all-client-code-distribution-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/retrieve-single-client-code-distribution-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/retrieve-single-client-code-distribution-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/download-single-client-code-distribution' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/download-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/add-or-replace-single-client-code-distribution' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/add-or-replace-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/delete-single-client-code-distribution' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/custom-pages/delete-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(CustomPagesRequest.class)
