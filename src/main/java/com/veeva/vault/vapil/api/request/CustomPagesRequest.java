 ...
 * </ul>
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.2/#direct-data">https://developer.veevavault.com/api/25.2/#direct-data</a>
 */
...
public class CustomPagesRequest extends VaultRequest<CustomPagesRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#retrieve-all-client-code-distribution-metadata' target='_blank'>https://developer.veevavault.com/api/25.2/#retrieve-all-client-code-distribution-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#retrieve-single-client-code-distribution-metadata' target='_blank'>https://developer.veevavault.com/api/25.2/#retrieve-single-client-code-distribution-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#download-single-client-code-distribution' target='_blank'>https://developer.veevavault.com/api/25.2/#download-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#add-or-replace-single-client-code-distribution' target='_blank'>https://developer.veevavault.com/api/25.2/#add-or-replace-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#delete-single-client-code-distribution' target='_blank'>https://developer.veevavault.com/api/25.2/#delete-single-client-code-distribution</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(CustomPagesRequest.class)
