 ...
 * </ul>
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data">https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data</a>
 */
...
public class DirectDataRequest extends VaultRequest<DirectDataRequest> {
     ...
     * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data/retrieve-available-direct-data-files' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data/retrieve-available-direct-data-files</a>
     * @vapil.request <pre>
     ...
     * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data/download-direct-data-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/direct-data/download-direct-data-file</a>
     * @vapil.request <pre>
