 ...
 * Document Events
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/24.2/#document-events">https://developer.veevavault.com/api/24.2/#document-events</a>
 */
public class DocumentEventRequest extends VaultRequest<DocumentEventRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-document-event-subtype-metadata' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-document-event-subtype-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#create-document-event' target='_blank'>https://developer.veevavault.com/api/24.2/#create-document-event</a>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-document-events' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-document-events</a>
	 * @vapil.request <pre>
