 ...
 * Document Events
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events">https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events</a>
 */
public class DocumentEventRequest extends VaultRequest<DocumentEventRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-event-types-and-subtypes' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-event-types-and-subtypes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-event-subtype-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-event-subtype-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/create-document-event' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/create-document-event</a>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-events' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-events/retrieve-document-events</a>
	 * @vapil.request <pre>
