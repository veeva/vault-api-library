 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows">https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows</a>
 */
public class DocumentLifecycleRequest extends VaultRequest<DocumentLifecycleRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-document-user-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-document-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-user-actions-on-multiple-documents' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-user-actions-on-multiple-documents</a>
	 * @vapil.request <pre>
	 * DocumentActionResponse response = vaultClient.newRequest(DocumentLifecycleRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-document-entry-criteria' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/retrieve-document-entry-criteria</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/initiate-document-user-action' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/initiate-document-user-action</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/initiate-bulk-document-user-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/initiate-bulk-document-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * GET /api/{version}/objects/documents/{id}/versions/{major_version}/{minor_version}/lifecycle_actions</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-binder-user-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-binder-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-user-actions-on-multiple-binders' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-user-actions-on-multiple-binders</a>
	 * @vapil.request <pre>
	 * BinderActionResponse response = vaultClient.newRequest(DocumentLifecycleRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-binder-entry-criteria' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/retrieve-binder-entry-criteria</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/initiate-binder-user-action' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/initiate-binder-user-action</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/initiate-bulk-binder-user-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/binder-user-actions/initiate-bulk-binder-user-actions</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(DocumentLifecycleRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/download-controlled-copy-job-results' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-user-actions/download-controlled-copy-job-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/retrieve-lifecycle-role-assignment-rules-default-override' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/retrieve-lifecycle-role-assignment-rules-default-override</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/create-lifecycle-role-assignment-override-rules' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/create-lifecycle-role-assignment-override-rules</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/update-lifecycle-role-assignment-rules-default-override' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/update-lifecycle-role-assignment-rules-default-override</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * DELETE /api/{version}/configuration/role_assignment_rule</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/delete-lifecycle-role-assignment-override-rules' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/lifecycle-role-assignment-rules/delete-lifecycle-role-assignment-override-rules</a>
	 */
