...
import com.veeva.vault.vapil.api.model.response.DocumentWorkflowMetadataResponse;
...
/**
 * Document Lifecycle and Workflow requests
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/21.1/#document-lifecycle-amp-workflows">https://developer.veevavault.com/api/21.1/#document-lifecycle-amp-workflows</a>
 */
public class DocumentLifecycleWorkflowRequest extends VaultRequest {
	...
	private static final String URL_RETRIEVE_DOCUMENT_WORKFLOW_METADATA = "/metadata/objects/workflows";
	...
	private DocumentLifecycleWorkflowRequest() {
	}
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-user-actions' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#initiate-user-action' target='_blank'>https://developer.veevavault.com/api/21.1/#initiate-user-action</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-user-actions-on-multiple-documents-or-binders' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-user-actions-on-multiple-documents-or-binders</a>
	 * @vapil.request <pre>
	...
	/**
	 * <b>Retrieve the entry criteria for a workflow.</b>
	 *
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-entry-criteria' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-entry-criteria</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#download-controlled-copy-job-results' target='_blank'>https://developer.veevavault.com/api/21.1/#download-controlled-copy-job-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#bulk-document-state-change' target='_blank'>https://developer.veevavault.com/api/21.1/#bulk-document-state-change</a>
	 */
	...
	/**
	 * <b>Retrieve Document Workflow Metadata.</b>
	 *
	 * @return DocumentWorkflowMetadataResponse
	 * @vapil.api <pre>
	 * GET /api/{version}/metadata/objects/workflows</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-document-workflow-metadata' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-document-workflow-metadata</a>
	 */
	public DocumentWorkflowMetadataResponse retrieveDocumentWorkflowMetadata() {

		String url = vaultClient.getAPIEndpoint(URL_RETRIEVE_DOCUMENT_WORKFLOW_METADATA);

		HttpRequestConnector request = new HttpRequestConnector(url);
		request.addHeaderParam(HttpRequestConnector.HTTP_HEADER_ACCEPT, HttpRequestConnector.HTTP_CONTENT_TYPE_JSON);

		return send(HttpMethod.GET, request, DocumentWorkflowMetadataResponse.class);
	}
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-lifecycle-role-assignment-rules-default-amp-override' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-lifecycle-role-assignment-rules-default-amp-override</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#create-override-rules' target='_blank'>https://developer.veevavault.com/api/21.1/#create-override-rules</a>
	 * @vapil.request <pre>
	 * .newRequest(DocumentLifecycleWorkflowRequest.class).setInputPath(csvFilePath).createOverrideRules();</pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#update-override-rules' target='_blank'>https://developer.veevavault.com/api/21.1/#update-override-rules</a>
	 * @vapil.request <pre>
	 * .newRequest(DocumentLifecycleWorkflowRequest.class).setInputPath(csvFilePath).updateOverrideRules();</pre>
	 ...
	 * @vapil.api <pre>
	 * DELETE /api/{version}/configuration/role_assignment_rule</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#delete-override-rules' target='_blank'>https://developer.veevavault.com/api/21.1/#delete-override-rules</a>
	 */
	 ...
	 * @return The Request
	 */
	public DocumentLifecycleWorkflowRequest setQueryParams(Map<String, Object> queryParams) {
	 ...
	 * @return The Request
	 */
	public DocumentLifecycleWorkflowRequest setBinaryFile(String filename, byte[] binaryContent) {
	 ...
	 * @return The Request
	 */
	public DocumentLifecycleWorkflowRequest setLifecycleName(String lifecycleName) {
	 ...
	 * @return The Request
	 */
	public DocumentLifecycleWorkflowRequest setRoleName(String roleName) {
		this.role = roleName;
		return this;
	}
