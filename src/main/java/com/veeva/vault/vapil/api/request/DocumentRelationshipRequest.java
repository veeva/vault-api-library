 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships">https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships</a>
 */
public class DocumentRelationshipRequest extends VaultRequest<DocumentRelationshipRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-type-relationships' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-type-relationships</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-relationships' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-relationships</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-relationship' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/retrieve-document-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipRetrieveResponse response = vaultClient.newRequest(DocumentRelationshipRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/create-single-document-relationship' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/create-single-document-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/create-multiple-document-relationships' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/create-multiple-document-relationships</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/delete-single-document-relationship' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/delete-single-document-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipResponse response = vaultClient.newRequest(DocumentRelationshipRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/delete-multiple-document-relationships' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/documents/document-relationships/delete-multiple-document-relationships</a>
	 */
