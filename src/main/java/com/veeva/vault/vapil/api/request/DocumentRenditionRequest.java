 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions">https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions</a>
 */
public class DocumentRenditionRequest extends VaultRequest<DocumentRenditionRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/retrieve-document-renditions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/retrieve-document-renditions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/retrieve-document-version-renditions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/retrieve-document-version-renditions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/download-document-rendition-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/download-document-rendition-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/download-document-version-rendition-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/download-document-version-rendition-file</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/add-multiple-document-renditions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/add-multiple-document-renditions</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(DocumentRenditionRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/add-single-document-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/add-single-document-rendition</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(DocumentRenditionRequest.class)
	 * 				.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/upload-document-version-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/upload-document-version-rendition</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(DocumentRenditionRequest.class)
	 * 				.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/replace-document-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/replace-document-rendition</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(DocumentRenditionRequest.class)
	 * 				.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/replace-document-version-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/replace-document-version-rendition</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-multiple-document-renditions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-multiple-document-renditions</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(DocumentRenditionRequest.class)
	 * 				.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-single-document-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-single-document-rendition</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/update-multiple-document-renditions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/update-multiple-document-renditions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-document-version-rendition' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-renditions/delete-document-version-rendition</a>
	 * @vapil.request <pre>
