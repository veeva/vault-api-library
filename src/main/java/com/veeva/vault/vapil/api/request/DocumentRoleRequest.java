 ...
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles">https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles</a>
 */
public class DocumentRoleRequest extends VaultRequest<DocumentRoleRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/retrieve-all-document-roles' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/retrieve-all-document-roles</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/retrieve-document-role' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/retrieve-document-role</a>
	 * @vapil.request <pre>
	 * DocumentRoleRetrieveResponse response = vaultClient.newRequest(DocumentRoleRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/assign-users-groups-to-roles-on-a-single-document' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/assign-users-groups-to-roles-on-a-single-document</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/remove-users-groups-from-roles-on-a-single-document' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-binder-roles/document-roles/remove-users-groups-from-roles-on-a-single-document</a>
	 * @vapil.request <pre>
	 * DocumentRoleChangeResponse response = vaultClient.newRequest(DocumentRoleRequest.class)
