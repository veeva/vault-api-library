 ...
 * Document Events
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures">https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures</a>
 */
public class DocumentSignatureRequest extends VaultRequest<DocumentSignatureRequest> {
     ...
     * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures/retrieve-document-signature-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures/retrieve-document-signature-metadata</a>
     * @vapil.request <pre>
     ...
     * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures/retrieve-archived-document-signature-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/documents/document-signatures/retrieve-archived-document-signature-metadata</a>
     * @vapil.request <pre>
     * DocumentSignatureMetadataResponse response = vaultClient.newRequest(DocumentSignatureRequest.class)
