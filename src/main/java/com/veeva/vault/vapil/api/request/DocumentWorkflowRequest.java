 ...
 * workflows.
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-all-document-workflows">https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-all-document-workflows</a>
 */
public class DocumentWorkflowRequest extends VaultRequest<DocumentWorkflowRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-all-document-workflows' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-all-document-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-document-workflow-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/retrieve-document-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/initiate-document-workflow' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/document-lifecycle-workflows/document-workflows/initiate-document-workflow</a>
	 * @vapil.request <pre>
