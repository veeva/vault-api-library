...
public class DomainRequest extends VaultRequest<DomainRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.3/#retrieve-domain-information' target='_blank'>https://developer.veevavault.com/api/25.3/#retrieve-domain-information</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.3/#retrieve-domains' target='_blank'>https://developer.veevavault.com/api/25.3/#retrieve-domains</a>
	 * @vapil.request <pre>
