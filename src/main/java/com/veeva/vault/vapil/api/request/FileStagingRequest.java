 ...
 * </ul>
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging">https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging</a>
 */
public class FileStagingRequest extends VaultRequest<FileStagingRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/list-items-at-a-path' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/list-items-at-a-path</a>
	 * @vapil.request <pre>
	 * FileStagingItemBulkResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.listItemsAtAPath("u14105917");
	 * </pre>
	 * @vapil.response <pre>
	 * for (FileStagingItemBulkResponse.FileStagingItem fileStagingItem : response.getData()) {
	 * 		System.out.println("Kind: " + fileStagingItem.getKind());
	 * 		System.out.println("Name: " + fileStagingItem.getName());
	 * 		System.out.println("Path: " + fileStagingItem.getPath());
	 * }
	 * </pre>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/download-item-content' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/download-item-content</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.downloadItemContent("Documents/New/file.txt");
	 * </pre>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/create-folder-or-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/create-folder-or-file</a>
	 * @vapil.request <pre>
	 * FileStagingItemResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.setOverwrite(true)
	 * 		.setInputPath("src/test/resources/test_file.txt")
	 * 		.createFolderOrFile(FileStagingRequest.Kind.FILE, "test_file.txt");
	 * </pre>
	 * @vapil.response <pre>
	 * System.out.println("Kind: " + response.getData().getKind());
	 * System.out.println("Name: " + response.getData().getName());
	 * System.out.println("Path: " + response.getData().getPath());
	 * </pre>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/update-folder-or-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/update-folder-or-file</a>
	 * @vapil.request <pre>
	 * FileStagingJobResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.setName("u14105917/updated_test_file.txt")
	 * 		.updateFolderOrFile("test_file.txt");
	 * </pre>
	 * @vapil.response <pre>
	 ...
	 * @vapil.request <pre>
	 * FileStagingJobResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.deleteFolderOrFile("test_file.txt");
	 * </pre>
	 * @vapil.response <pre>
	 * int jobId =  response.getData().getJobId();
	 * String url = response.getData().getUrl();
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/create-resumable-upload-session' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/create-resumable-upload-session</a>
	 * @vapil.request <pre>
	 * long fileSize = new File(filePath).length();
	 * FileStagingSessionResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.setOverwrite(true)
	 * 		.createResumableUploadSession("test_file.txt", fileSize);
	 * </pre>
	 * @vapil.response <pre>
	 * String uploadSessionId = response.getData().getId();
	 * String path = response.getData().getPath();
	 * </pre>
	 */
	public FileStagingSessionResponse createResumableUploadSession(String path, long size) {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/upload-to-a-session' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/upload-to-a-session</a>
	 * @vapil.request <pre>
	 * FileStagingSessionPartResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.setFile(fileName, bytes)
	 * 		.uploadToASession(uploadSessionId, partNumber);
	 * </pre>
	 * @vapil.response <pre>
	 * System.out.println("Part Number: " + response.getData().getPartNumber());
	 * System.out.println("Size: " + response.getData().getSize());
	 * </pre>
	 */
	public FileStagingSessionPartResponse uploadToASession(String uploadSessionId, int partNumber) {
		...
		return send(HttpMethod.PUT, request, FileStagingSessionPartResponse.class);
	}
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/list-upload-sessions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/list-upload-sessions</a>
	 * @vapil.request <pre>
	 * FileStagingJobResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/list-upload-sessions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/commit-upload-session</a>
	 * @vapil.request <pre>
	 * FileStagingSessionBulkResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.listUploadSessions();
	 * </pre>
	 * @vapil.response <pre>
	 * for (ResumableUploadSession session : response.getData()) {
	 * 		System.out.println("Id: " + session.getId());
	 * 		System.out.println("Path: " + session.getPath());
	 * 		System.out.println("Size: " + session.getSize());
	 ...
	 * @vapil.request <pre>
	 * FileStagingSessionBulkResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 * 		.listUploadSessionsByPage(pageUrl);
	 * </pre>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/get-upload-session-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/get-upload-session-details</a>
	 * @vapil.request <pre>
	 * FileStagingSessionResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/list-file-parts-uploaded-to-session' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/list-file-parts-uploaded-to-session</a>
	 * @vapil.request <pre>
	 ...
	 * </pre>
	 * @vapil.response <pre>
	 * for (ResumableUploadSessionPart part : response.getData()) {
	 * 		System.out.println("Part Number: " + part.getPartNumber());
	 * 		System.out.println("Size: " + part.getSize());
	 * }
	 * </pre>
	 */
	public FileStagingSessionPartBulkResponse listFilePartsUploadedToASession(String uploadSessionId) {
		...
		return send(HttpMethod.GET, request, FileStagingSessionPartBulkResponse.class);
	}
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/abort-upload-session' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/file-staging/resumable-upload-sessions/abort-upload-session</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(FileStagingRequest.class)
