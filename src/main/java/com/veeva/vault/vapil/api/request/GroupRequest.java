 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/groups">https://general.veevavault.dev/vault-api/api-reference/26.2/groups</a>
 */
public class GroupRequest extends VaultRequest<GroupRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-group-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-group-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-all-groups' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-all-groups</a>
	 * @vapil.request <pre>
	 * GroupRetrieveResponse resp = vaultClient.newRequest(GroupRequest.class)
	 * 				.setIncludeImplied(includeImplied)
	 * 				.retrieveAllGroups();</pre>
	 * @vapil.response <pre>
	...
	public GroupRetrieveResponse retrieveAllGroups() {
		HttpRequestConnector request = new HttpRequestConnector(vaultClient.getAPIEndpoint(URL_GROUPS_RETRIEVE_ALL));
	...
	public GroupRetrieveAutoManagedResponse retrieveAllGroupsAutoManaged() {
		HttpRequestConnector request = new HttpRequestConnector(vaultClient.getAPIEndpoint(URL_GROUPS_RETRIEVE_ALL_AUTO));

		if (includeImplied != null && includeImplied)
			request.addQueryParam("includeImplied", String.valueOf(includeImplied).toLowerCase());

		return send(HttpMethod.GET, request, GroupRetrieveAutoManagedResponse.class);
	}
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/retrieve-group</a>
	 * @vapil.request <pre>
	 * GroupRetrieveResponse resp = vaultClient.newRequest(GroupRequest.class)
	 * 				.setIncludeImplied(includeImplied)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/create-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/create-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/update-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/update-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/groups/delete-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/groups/delete-group</a>
	 * @vapil.request <pre>
