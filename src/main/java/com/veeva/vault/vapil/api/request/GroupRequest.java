 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/21.3/#domain-information">https://developer.veevavault.com/api/21.3/#domain-information</a>
 */
public class GroupRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#retrieve-group-metadata' target='_blank'>https://developer.veevavault.com/api/21.3/#retrieve-group-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#retrieve-all-groups' target='_blank'>https://developer.veevavault.com/api/21.3/#retrieve-all-groups</a>
	 * @vapil.api <pre>
	 * GET /api/{version}/objects/groups/auto</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#' target='_blank'>https://developer.veevavault.com/api/21.3/#</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#retrieve-group' target='_blank'>https://developer.veevavault.com/api/21.3/#retrieve-group</a>
	 * @vapil.request <pre>
	 * GroupRetrieveResponse resp = vaultClient.newRequest(GroupRequest.class)
	 * 				.setIncludeImplied(includeImplied)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#create-group' target='_blank'>https://developer.veevavault.com/api/21.3/#create-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#update-group' target='_blank'>https://developer.veevavault.com/api/21.3/#update-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.3/#delete-group' target='_blank'>https://developer.veevavault.com/api/21.3/#delete-group</a>
	 * @vapil.request <pre>
