 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/groups">https://general.veevavault.dev/vault-api/api-reference/26.1/groups</a>
 */
public class GroupRequest extends VaultRequest<GroupRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-group-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-group-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-all-groups' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-all-groups</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/retrieve-group</a>
	 * @vapil.request <pre>
	 * GroupRetrieveResponse resp = vaultClient.newRequest(GroupRequest.class)
	 * 				.setIncludeImplied(includeImplied)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/create-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/create-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/update-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/update-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/groups/delete-group' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/groups/delete-group</a>
	 * @vapil.request <pre>
