 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/jobs">https://general.veevavault.dev/vault-api/api-reference/26.2/jobs</a>
 */
public class JobRequest extends VaultRequest<JobRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-histories' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-histories</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-monitors' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-monitors</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-job-status</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * GET /api/{version}/services/jobs/{job_id}/tasks</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-sdk-job-tasks' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/retrieve-sdk-job-tasks</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/start-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/start-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/cancel-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/jobs/cancel-job</a>
	 * @vapil.request <pre>
