 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/24.2/#vault-loader">https://developer.veevavault.com/api/24.2/#vault-loader</a>
 */
public class LoaderRequest extends VaultRequest<LoaderRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#extract-data-files' target='_blank'>https://developer.veevavault.com/api/24.2/#extract-data-files</a>
	 */
	public LoaderResponse extractDataFiles() {
		...
		if (json != null) {
			...
			ArrayNode loaderTaskArray = JsonNodeFactory.instance.arrayNode();
			for (LoaderTask loaderTask : loaderTasks) {
				loaderTaskArray.add(loaderTask.toJSONObject());
			}
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#load-data-objects' target='_blank'>https://developer.veevavault.com/api/24.2/#load-data-objects</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-loader-extract-results' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-extract-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-loader-extract-renditions-results' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-loader-extract-renditions-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-load-success-log-results' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-load-success-log-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-load-failure-log-results' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-load-failure-log-results</a>
	 */
	 ...
	 * @vapil.api <pre>
	 * GET /api/{version}/services/loader/{job_id}/tasks/{task_id}/results</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/24.2/#retrieve-extract-results' target='_blank'>https://developer.veevavault.com/api/24.2/#retrieve-extract-results</a>
	 */
