 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/22.3/#vault-loader">https://developer.veevavault.com/api/22.3/#vault-loader</a>
 */
public class LoaderRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#extract-data-files' target='_blank'>https://developer.veevavault.com/api/22.3/#extract-data-files</a>
	 */
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#load-data-objects' target='_blank'>https://developer.veevavault.com/api/22.3/#load-data-objects</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#retrieve-extract-results' target='_blank'>https://developer.veevavault.com/api/22.3/#retrieve-extract-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#retrieve-loader-extract-renditions-results' target='_blank'>https://developer.veevavault.com/api/22.3/#retrieve-loader-extract-renditions-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#retrieve-load-success-log-results' target='_blank'>https://developer.veevavault.com/api/22.3/#retrieve-load-success-log-results</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/22.3/#retrieve-load-failure-log-results' target='_blank'>https://developer.veevavault.com/api/22.3/#retrieve-load-failure-log-results</a>
	 */
