 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/23.2/#object-lifecycle-amp-workflows">https://developer.veevavault.com/api/23.2/#object-lifecycle-amp-workflows</a>
 */
public class ObjectLifecycleWorkflowRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-object-record-user-actions' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-object-record-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-object-user-action-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-object-user-action-details</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#initiate-object-action-on-a-single-record' target='_blank'>https://developer.veevavault.com/api/23.2/#initiate-object-action-on-a-single-record</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#initiate-object-action-on-multiple-records' target='_blank'>https://developer.veevavault.com/api/23.2/#initiate-object-action-on-multiple-records</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflows' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-actions' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-action-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-action-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#initiate-workflow-action' target='_blank'>https://developer.veevavault.com/api/23.2/#initiate-workflow-action</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#multi-record-workflows' target='_blank'>https://developer.veevavault.com/api/23.2/#multi-record-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-multi-record-workflow-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-multi-record-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#initiate-multi-record-workflow' target='_blank'>https://developer.veevavault.com/api/23.2/#initiate-multi-record-workflow</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-object-workflow-tasks' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-object-workflow-tasks</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-actions' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-actions</a>
	 * @vapil.request <pre>
	 * ObjectWorkflowActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class).setLoc(false)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-action-details' target='_blank'>https://developer.veevavault.com/api/23.2/#retrieve-workflow-task-action-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.2/#initiate-workflow-task-action' target='_blank'>https://developer.veevavault.com/api/23.2/#initiate-workflow-task-action</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 * 				.setBodyParams(bodyParams)
