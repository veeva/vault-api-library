 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows">https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows</a>
 */
public class ObjectLifecycleWorkflowRequest extends VaultRequest<ObjectLifecycleWorkflowRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/retrieve-object-record-user-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/retrieve-object-record-user-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/retrieve-object-user-action-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/retrieve-object-user-action-details</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/initiate-object-action-on-a-single-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/initiate-object-action-on-a-single-record</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/initiate-object-action-on-multiple-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/object-record-user-actions/initiate-object-action-on-multiple-records</a>
	 * @vapil.request <pre>
	 * ObjectRecordActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflows' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-actions</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-action-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/retrieve-workflow-action-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/initiate-workflow-action' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/initiate-workflow-action</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/multi-record-workflows/retrieve-multi-record-workflow-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/multi-record-workflows/retrieve-multi-record-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/multi-record-workflows/initiate-multi-record-workflow' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/object-lifecycle-workflows/multi-record-workflows/initiate-multi-record-workflow</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-tasks' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-tasks</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-actions' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-actions</a>
	 * @vapil.request <pre>
	 * ObjectWorkflowActionResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class).setLoc(false)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-action-details' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/retrieve-workflow-task-action-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/accept-single-record-workflow-task' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/workflow-tasks/accept-single-record-workflow-task</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(ObjectLifecycleWorkflowRequest.class)
	 * 				.setBodyParams(bodyParams)
...
//			and just use the application/json header as provided.
	 ...
	 * </pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/complete-job-step' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/workflows/complete-job-step</a>
	 * @vapil.request <pre>
