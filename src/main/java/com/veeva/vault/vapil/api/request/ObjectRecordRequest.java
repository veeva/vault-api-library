 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects">https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects</a>
 * <p>
...
public class ObjectRecordRequest extends VaultRequest<ObjectRecordRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/create-upsert-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/create-upsert-object-records</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/roll-up-fields/recalculate-roll-up-fields' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/roll-up-fields/recalculate-roll-up-fields</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/roll-up-fields/retrieve-roll-up-field-recalculation-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/roll-up-fields/retrieve-roll-up-field-recalculation-status</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/update-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/update-object-records</a>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/delete-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/delete-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - Source - CSV file, Response - JSON</i>
	 * ObjectRecordBulkResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 				.setContentTypeCsv()
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/cascade-delete-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/cascade-delete-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-results-of-cascade-delete-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-results-of-cascade-delete-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/retrieve-details-from-all-object-types' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/retrieve-details-from-all-object-types</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/retrieve-details-from-a-specific-object' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/retrieve-details-from-a-specific-object</a>
	 * @vapil.request <pre>
	 * ObjectRecordTypeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/change-object-type' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-types/change-object-type</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 					.setContentTypeCsv()
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-object-record-roles' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-object-record-roles</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-roles/assign-users-groups-to-roles-on-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-roles/assign-users-groups-to-roles-on-object-records</a>
	 * @vapil.response <pre>
	 * <i>Example 1 - CSV</i>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-roles/remove-users-groups-from-roles-on-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/object-roles/remove-users-groups-from-roles-on-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - CSV</i>
	 * ObjectRecordRoleChangeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 			.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/deep-copy-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/deep-copy-object-record</a>
	 * @vapil.request <pre>
	 * JobCreateResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-results-of-deep-copy-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-results-of-deep-copy-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-deleted-object-record-id' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-deleted-object-record-id</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-limits-on-objects' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/retrieve-limits-on-objects</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/update-corporate-currency-fields' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/update-corporate-currency-fields</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/initiate-record-merge' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/initiate-record-merge</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/retrieve-record-merge-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/retrieve-record-merge-status</a>
	 * @vapil.request <pre>
	 * JobStatusResponse response = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/retrieve-record-merge-results' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/vault-objects/merge-object-records/retrieve-record-merge-results</a>
	 * @vapil.request <pre>
