 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/23.1/#vault-objects">https://developer.veevavault.com/api/23.1/#vault-objects</a>
 * <p>
...
public class ObjectRecordRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-object-record' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#create-object-records' target='_blank'>https://developer.veevavault.com/api/23.1/#create-object-records</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#update-object-records' target='_blank'>https://developer.veevavault.com/api/23.1/#update-object-records</a>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#delete-object-records' target='_blank'>https://developer.veevavault.com/api/23.1/#delete-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - Source - CSV file, Response - JSON</i>
	 * ObjectRecordBulkResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 				.setContentTypeCsv()
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#cascade-delete-object-record' target='_blank'>https://developer.veevavault.com/api/23.1/#cascade-delete-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#get-results-of-cascade-delete-job' target='_blank'>https://developer.veevavault.com/api/23.1/#get-results-of-cascade-delete-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-details-from-all-object-types' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-details-from-all-object-types</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-details-from-a-specific-object' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-details-from-a-specific-object</a>
	 * @vapil.request <pre>
	 * ObjectRecordTypeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#change-object-type' target='_blank'>https://developer.veevavault.com/api/23.1/#change-object-type</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 					.setContentTypeCsv()
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-object-record-roles' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-object-record-roles</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#assign-users-amp-groups-to-roles-on-object-records' target='_blank'>https://developer.veevavault.com/api/23.1/#assign-users-amp-groups-to-roles-on-object-records</a>
	 * @vapil.response <pre>
	 * <i>Example 1 - CSV</i>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#remove-users-amp-groups-from-roles-on-object-records' target='_blank'>https://developer.veevavault.com/api/23.1/#remove-users-amp-groups-from-roles-on-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - CSV</i>
	 * ObjectRecordRoleChangeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 			.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#deep-copy-object-record' target='_blank'>https://developer.veevavault.com/api/23.1/#deep-copy-object-record</a>
	 * @vapil.request <pre>
	 * JobCreateResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#get-results-of-deep-copy-job' target='_blank'>https://developer.veevavault.com/api/23.1/#get-results-of-deep-copy-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-deleted-object-record-id' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-deleted-object-record-id</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#retrieve-limits-on-objects' target='_blank'>https://developer.veevavault.com/api/23.1/#retrieve-limits-on-objects</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/23.1/#update-corporate-currency-fields' target='_blank'>https://developer.veevavault.com/api/23.1/#update-corporate-currency-fields</a>
	 */
