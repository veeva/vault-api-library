 ...
 * 			.createAndUpsertObjectRecords(objectName);</pre>
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects">https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects</a>
 * <p>
...
public class ObjectRecordRequest extends VaultRequest<ObjectRecordRequest> {
	private static Logger log = LoggerFactory.getLogger(ObjectRecordRequest.class);
	...
	/**
	 * <b>X-VaultAPI-NoTriggers</b> When set to true, it bypasses all system, standard, and custom triggers when using Record Migration Mode.
	 */
	public static final String HTTP_HEADER_VAULT_NO_TRIGGERS = "X-VaultAPI-NoTriggers";
	...
	private static final String URL_OBJ_INITIATE_MERGE = "/vobjects/{object_name}/actions/merge";
	private static final String URL_OBJ_RETRIEVE_MERGE_STATUS = "/vobjects/merges/{job_id}/status";
	private static final String URL_OBJ_RETRIEVE_MERGE_RESULTS = "/vobjects/merges/{job_id}/results";
	private static final String URL_OBJ_ROLLUP_RECALCULATE = "/vobjects/{object_name}/actions/recalculaterollups";
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/create-upsert-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/create-upsert-object-records</a>
	 * @vapil.request <pre>
	 ...
	 * }</pre>
	 */
	public ObjectRecordBulkResponse createAndUpsertObjectRecords(String objectName) {
		return sendObjectRecordRequest(objectName, HttpMethod.POST, vaultClient.getAPIEndpoint(URL_OBJ));
	}

	/**
	 * <b>Recalculate Roll-up Fields</b>
	 *
	 * @param objectName The name of the object on which to start the Roll-up field recalculation.
	 * @return VaultResponse
	 * @vapil.api <pre>
	 * POST /api/{version}/vobjects/{object_name}/actions/recalculaterollups</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/roll-up-fields/recalculate-roll-up-fields' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/roll-up-fields/recalculate-roll-up-fields</a>
	 * @vapil.request <pre>
	...
	public VaultResponse recalculateRollupFields(String objectName) {
		String url = vaultClient.getAPIEndpoint(URL_OBJ_ROLLUP_RECALCULATE);
		url = url.replace("{object_name}", objectName);
	...
	/**
	 * <b>Retrieve Roll-up Field Recalculation Status</b>
	 *
	 * @param objectName The name of the object on which to start the Roll-up field recalculation.
	 * @return JobStatusResponse
	 * @vapil.api <pre>
	 * GET /api/{version}/vobjects/{object_name}/actions/recalculaterollups</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/roll-up-fields/retrieve-roll-up-field-recalculation-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/roll-up-fields/retrieve-roll-up-field-recalculation-status</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/update-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/update-object-records</a>
	 * @vapil.request See {@link #createAndUpsertObjectRecords(String)} for example requests (replace "createAndUpsertObjectRecords" with "updateObjectRecords")
	 * @vapil.response See {@link #createAndUpsertObjectRecords(String)} for example responses (replace "createAndUpsertObjectRecords" with "updateObjectRecords")
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/delete-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/delete-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - Source - CSV file, Response - JSON</i>
	 * ObjectRecordBulkResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 				.setContentTypeCsv()
	 ...
	 * See {@link #createAndUpsertObjectRecords(String)} for additional example requests (replace "createAndUpsertObjectRecords" with "deleteObjectRecords")</pre>
	 * @vapil.response See {@link #createAndUpsertObjectRecords(String)} for example responses (replace "createAndUpsertObjectRecords" with "deleteObjectRecords")
	 */
	...
	private ObjectRecordBulkResponse sendObjectRecordRequest(String objectName, HttpMethod method, String url) {
		...
		if (noTriggers != null)
			request.addHeaderParam(HTTP_HEADER_VAULT_NO_TRIGGERS, noTriggers);
		...
		if (inputStream != null) {
			request.addInputStream(headerContentType, inputStream);
		}
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/cascade-delete-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/cascade-delete-object-record</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-results-of-cascade-delete-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-results-of-cascade-delete-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/retrieve-details-from-all-object-types' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/retrieve-details-from-all-object-types</a>
	 * @vapil.request <pre>
	...
	public ObjectRecordTypeBulkResponse retrieveDetailsFromAllObjectTypes() {
		...
		HttpRequestConnector request = new HttpRequestConnector(url);
		return send(HttpMethod.GET, request, ObjectRecordTypeBulkResponse.class);
	}
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/retrieve-details-from-a-specific-object' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/retrieve-details-from-a-specific-object</a>
	 * @vapil.request <pre>
	 * ObjectRecordTypeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/change-object-type' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-types/change-object-type</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 					.setContentTypeCsv()
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-object-record-roles' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-object-record-roles</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-roles/assign-users-groups-to-roles-on-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-roles/assign-users-groups-to-roles-on-object-records</a>
	 * @vapil.response <pre>
	 * <i>Example 1 - CSV</i>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-roles/remove-users-groups-from-roles-on-object-records' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/object-roles/remove-users-groups-from-roles-on-object-records</a>
	 * @vapil.request <pre>
	 * <i>Example 1 - CSV</i>
	 * ObjectRecordRoleChangeResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 			.setInputPath(inputPath)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/deep-copy-object-record' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/deep-copy-object-record</a>
	 * @vapil.request <pre>
	 * JobCreateResponse resp = vaultClient.newRequest(ObjectRecordRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-results-of-deep-copy-job' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-results-of-deep-copy-job</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-deleted-object-record-id' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-deleted-object-record-id</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-limits-on-objects' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/retrieve-limits-on-objects</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/update-corporate-currency-fields' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/update-corporate-currency-fields</a>
	 */
	...
	/**
	 * <b>Initiate Record Merge</b>
	 * <p>
	 * Initiate a record merge operation in bulk. Starts a record merge job.
	 * When merging two records together, you must select one record to be the main_record_id and one record to be the duplicate_record_id.
	 * <p>
	 * Add raw JSON request string by calling the "setRequestString" in the builder.
	 *
	 * @param objectName The object name for the records being merged
	 * @return ObjectRecordMergeJobResponse
	 * @vapil.api <pre>
	 * POST /api/{version}/vobjects/{object_name}/actions/merge</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/initiate-record-merge' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/initiate-record-merge</a>
	 * @vapil.request <pre>
	 ...
	 *
	 * <i>Example 2 - JSON input</i>
	 * ObjectRecordMergeJobResponse response = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 		.setContentTypeJson()
	 * 		.setRequestString(jsonRequestString)
	 * 		.initiateRecordMerge(objectName);
	 *
	 * <i>Example 3 - Binary input</i>
	 * ObjectRecordMergeJobResponse response = vaultClient.newRequest(ObjectRecordRequest.class)
	 * 		.setContentTypeCsv()
	...
	public ObjectRecordMergeJobResponse initiateRecordMerge(String objectName) {
		String url = vaultClient.getAPIEndpoint(URL_OBJ_INITIATE_MERGE);
		url = url.replace("{object_name}", objectName);
		...
		return send(HttpMethod.POST, request, ObjectRecordMergeJobResponse.class);
	}

	/**
	 * <b>Retrieve Record Merge Status</b>
	 * <p>
	 * Given a job_id for a merge records job, retrieve the job status.
	 * <p>
	 * Before submitting this request:
	 * <ol>
	 *     <li>You must have previously requested a record merge job</li>
	 *     <li>You must have a valid job_id field value returned from the record merge operation</li>
	 * </ol>
	 *
	 * @param jobId The job id field value returned from the merge operation.
	 * @return JobStatusResponse
	 * @vapil.api <pre>
	 * GET /api/{version}/vobjects/merges/{job_id}/status</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/retrieve-record-merge-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/retrieve-record-merge-status</a>
	 * @vapil.request <pre>
	 * JobStatusResponse response = vaultClient.newRequest(ObjectRecordRequest.class)
	...
	public JobStatusResponse retrieveRecordMergeStatus(int jobId) {
		String url = vaultClient.getAPIEndpoint(URL_OBJ_RETRIEVE_MERGE_STATUS);
		url = url.replace("{job_id}", String.valueOf(jobId));
	...
	/**
	 * <b>Retrieve Record Merge Results</b>
	 * <p>
	 * Given a job_id for a merge records job, retrieve the job results.
	 * <p>
	 * Before submitting this request:
	 * <ol>
	 *     <li>You must have previously requested a record merge job which is no longer in progress</li>
	 *     <li>You must have a valid job_id field value returned from the record merge operation</li>
	 * </ol>
	 *
	 * @param jobId The job id field value returned from the merge operation.
	 * @return JobStatusResponse
	 * @vapil.api <pre>
	 * GET /api/{version}/vobjects/merges/{job_id}/results</pre>
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/retrieve-record-merge-results' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/vault-objects/merge-object-records/retrieve-record-merge-results</a>
	 * @vapil.request <pre>
	...
	public ObjectRecordMergeResultsResponse retrieveRecordMergeResults(int jobId) {
		String url = vaultClient.getAPIEndpoint(URL_OBJ_RETRIEVE_MERGE_RESULTS);
		url = url.replace("{job_id}", String.valueOf(jobId));

		HttpRequestConnector request = new HttpRequestConnector(url);
		return send(HttpMethod.GET, request, ObjectRecordMergeResultsResponse.class);
	}
	...
	private boolean isValidCRUDRequest() {
		...
		// Verify there is data - file, binary, stream, or name/value pairs
		boolean hasNoData = (inputPath == null || inputPath.isEmpty()) &&
				(bodyParams == null || bodyParams.isEmpty()) &&
				(requestString == null || requestString.isEmpty()) &&
				(binaryFile == null || binaryFile.getBinaryContent() == null) &&
				(inputStream == null);
	...
	*/
	 ...
	 * label, label_plural, and help_content object type fields.
	 *
	...
	/**
	 * When set to true, it bypasses all system, standard,
	 * and custom triggers when using Record Migration Mode.
	 * API user must have the Record Migration permission to use this header.
	 *
	 * @param noTriggers Boolean value to bypass triggers
	 * @return The Request
	 */
	 ...
	 *
	 * @param inputStream The source data as an input stream
	 * @return The Request
	 */
