 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.2/#picklists">https://developer.veevavault.com/api/25.2/#picklists</a>
 */
public class PicklistRequest extends VaultRequest<PicklistRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#retrieve-all-picklists' target='_blank'>https://developer.veevavault.com/api/25.2/#retrieve-all-picklists</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#retrieve-picklist-values' target='_blank'>https://developer.veevavault.com/api/25.2/#retrieve-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#create-picklist-values' target='_blank'>https://developer.veevavault.com/api/25.2/#create-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#update-picklist-value-label' target='_blank'>https://developer.veevavault.com/api/25.2/#update-picklist-value-label</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#update-picklist-value' target='_blank'>https://developer.veevavault.com/api/25.2/#update-picklist-value</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.2/#inactivate-picklist-value' target='_blank'>https://developer.veevavault.com/api/25.2/#inactivate-picklist-value</a>
	 * @vapil.request <pre>
