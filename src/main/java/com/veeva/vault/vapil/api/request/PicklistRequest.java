 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/picklists">https://general.veevavault.dev/vault-api/api-reference/26.1/picklists</a>
 */
public class PicklistRequest extends VaultRequest<PicklistRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/retrieve-all-picklists' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/retrieve-all-picklists</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/retrieve-picklist-values' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/retrieve-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/create-picklist-values' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/create-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/update-picklist-value-label' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/update-picklist-value-label</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/update-picklist-value' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/update-picklist-value</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/inactivate-picklist-value' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/picklists/inactivate-picklist-value</a>
	 * @vapil.request <pre>
