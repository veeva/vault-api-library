 ...
 * SCIM Requests
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/scim">https://general.veevavault.dev/vault-api/api-reference/26.2/scim</a>
 */
...
public class SCIMRequest extends VaultRequest<SCIMRequest> {
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/discovery-endpoints' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/discovery-endpoints</a>
	 *
	 * @vapil.request
	 * <pre>
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/create-user-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/create-user-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
	 * <i>Example 1 - JSON</i>
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-all-users-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-all-users-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-single-user-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-single-user-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
	 * SCIMUserResponse scimResponse = vaultClient.newRequest(SCIMRequest.class)
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-current-user-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-current-user-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
	 * SCIMUserResponse scimResponse = vaultClient.newRequest(SCIMRequest.class)
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/update-current-user-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/update-current-user-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
	 * SCIMUserResponse scimResponse = vaultClient.newRequest(SCIMRequest.class)
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-scim-resources' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/retrieve-scim-resources</a>
	 *
	 * @vapil.request
	 * <pre>
	 * SCIMResponse scimResponse = vaultClient.newRequest(SCIMRequest.class)
	 ...
	 *
	 * @vapil.vaultlink
	 * <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/update-user-with-scim' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/scim/users/update-user-with-scim</a>
	 *
	 * @vapil.request
	 * <pre>
