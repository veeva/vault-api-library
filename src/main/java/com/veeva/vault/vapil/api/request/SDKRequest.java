 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk">https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk</a>
 */
public class SDKRequest extends VaultRequest<SDKRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/retrieve-single-source-code-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/retrieve-single-source-code-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/disable-vault-extension' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/disable-vault-extension</a>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/enable-vault-extension' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/enable-vault-extension</a>
	 * @vapil.response <pre>
	 * System.out.println("Status = " + resp.getResponseStatus());
	 * </pre>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/add-or-replace-single-source-code-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/add-or-replace-single-source-code-file</a>
	 * @vapil.request <pre>
	 * SDKResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/delete-single-source-code-file' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/delete-single-source-code-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/validate-imported-package' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/validate-imported-package</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/retrieve-all-queues' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/retrieve-all-queues</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/retrieve-queue-status' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/retrieve-queue-status</a>
	 * @vapil.request <pre>
	 * QueueResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/disable-delivery' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/disable-delivery</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/enable-delivery' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/enable-delivery</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/reset-queue' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/queues/reset-queue</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/retrieve-signing-certificate' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.2/managing-vault-java-sdk/retrieve-signing-certificate</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(SDKRequest.class)
