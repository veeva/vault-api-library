 ...
 *
 * @vapil.apicoverage <a href="https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-all-security-policies">https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-all-security-policies</a>
 */
public class SecurityPolicyRequest extends VaultRequest<SecurityPolicyRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-security-policy-metadata' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-security-policy-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-all-security-policies' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-all-security-policies</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-security-policy' target='_blank'>https://general.veevavault.dev/vault-api/api-reference/26.1/security-policies/retrieve-security-policy</a>
	 * @vapil.request <pre>
