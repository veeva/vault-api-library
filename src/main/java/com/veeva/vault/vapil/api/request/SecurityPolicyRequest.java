 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/21.1/#retrieve-all-security-policies">https://developer.veevavault.com/api/21.1/#retrieve-all-security-policies</a>
 */
public class SecurityPolicyRequest extends VaultRequest {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-all-security-policies' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-all-security-policies</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/21.1/#retrieve-security-policy' target='_blank'>https://developer.veevavault.com/api/21.1/#retrieve-security-policy</a>
	 * @vapil.request <pre>
